...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r border-neutral-800/50 py-6 sm:py-10 relative group/feature",
    ...
    >
      ...
      <div className="mb-3 sm:mb-4 relative z-10 px-6 sm:px-10 text-white">
        {icon}
      </div>
      ...
      <p className="text-xs sm:text-sm text-white max-w-xs relative z-10 px-6 sm:px-10">
        {description}
      </p>
    </div>
  );
